...
const app = express();
const sequelize = new Sequelize("postgres://postgres:ostentapp@database-eventosapp.cgm72eza25xd.us-east-1.rds.amazonaws.com:5432/eventosapp"); // Example for postgres
